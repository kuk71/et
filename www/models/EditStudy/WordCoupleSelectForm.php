...
class WordCoupleSelectForm extends Model
{
    ...
    /**
     * Возвращает массив из Id вариантов перевода слова которые ранее были выбраны пользователем
     * - с id = $this->wordForStudyId
     * - на язык c id = $this->languageTranslationId
     */
    public function getWordCoupleListBeforeSelected($userId)
    {
        $worfCoupleId = WordCoupleList::getWordCoupleBeforeSelected($this->wordForStudyId, $this->languageTranslationId, $userId);
        return array_column($worfCoupleId, "word_couple_id");
    }
