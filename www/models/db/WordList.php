 ...
 * @property string $word_spelling_for_search - Написание слова на языке оригинала
...
class WordList extends ActiveRecord
{
    ...
    public static function getWordsFoundByFirstLetters($firstLettersWord, $languageId = 2)
    {
        $wordList = self::find()
            ...
            ->andWhere(['like', 'word_spelling_for_search', $firstLettersWord . '%', false])
            ->orderBy(['word_spelling_for_search' => SORT_ASC])
            ->limit(10)
            ->asArray()
            ->all();
