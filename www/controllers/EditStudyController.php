...
class EditStudyController extends Controller
{
    ...
    public function actionDeleteStudyKit()
    {
        ...
        // переадресовать на страницу со списком коллекций
    ...
    /**
     * Отрисовывает форму выбора слов для заучивания
     *
     * @param $kitId
     * @param $errorText
     * @return string
    ...
    /**
     * возвращает переданный через GET id формируемой коллекции слов для изучения
